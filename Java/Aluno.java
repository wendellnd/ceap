...
public class Aluno extends JLabel{
	...
	JCheckBox cbsit,cbsat,cbsrt;
	JRadioButton rbf,rbm;
	...
	public void InicializarComponentes() {
		...
		cbsit.setBounds(70,110,40,20);
		cbsit.setBounds(120,110,40,20);
		cbsit.setBounds(170,110,40,20);
		
		rbf.setBounds(90,140,40,20);
		rbm.setBounds(110,140,40,20);
