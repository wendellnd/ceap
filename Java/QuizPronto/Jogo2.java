...
public class Jogo2 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	int tempo,a;
	File pink = new File("C:\\Users\\wende\\Downloads\\Quiz\\gta.wav");
	Clip clip;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\gta.jpg");
		...
		lbp1 = new JLabel("Qual o primeiro GTA 3D?");
		...
		rba1 = new JRadioButton("GTA III");
		rba2 = new JRadioButton("GTA San Andreas");
		rba3 = new JRadioButton("GTA II");
		rba4 = new JRadioButton("GTA Vice City");
		rba5 = new JRadioButton("GTA IV");
...
//		lbp1.setFont(f);
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Jogo2());
