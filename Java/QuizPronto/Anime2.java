...
public class Anime2 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	int tempo,a;
	File pink = new File("C:\\Users\\wende\\Downloads\\Quiz\\gomuno.wav");
	Clip clip;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\luffy.jpg");
		...
		lbp1 = new JLabel("Qual a fruta que Luffy comeu?");
		...
		rba1 = new JRadioButton("Gomu Gomu No Mi");
		rba2 = new JRadioButton("Baku Baku No Mi");
		rba3 = new JRadioButton("Doru Doru No Mi");
		rba4 = new JRadioButton("Doa Doa No Mi");
		rba5 = new JRadioButton("Beri Beri No Mi");
...
//		lbp1.setFont(f);
		...
		add(lbcerto);
		add(lberrado);
		ImageIcon musica = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\anime.jpg");
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Anime2());
