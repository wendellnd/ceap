...
public class Jogo5 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	...
	public void InicializarComponentes() {
		...
		lbp1 = new JLabel("Qual o video game mais vendido dessa geração?");
		...
		rba1 = new JRadioButton("Xbox One");
		rba2 = new JRadioButton("Nintendo UWii");
		rba3 = new JRadioButton("Nintendo Switch");
		rba4 = new JRadioButton("Nintendo 3Ds");
		rba5 = new JRadioButton("PS4");
...
//		lbp1.setFont(f);
	...
	public void DefinirEventos() {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(null,"Console da Sony");
		}
		});
	}
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Jogo5());
