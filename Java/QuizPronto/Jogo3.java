...
public class Jogo3 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	int tempo,a;
	File pink = new File("C:\\Users\\wende\\Downloads\\Quiz\\tetris.wav");
	Clip clip;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\din.jpg");
		...
		lbp1 = new JLabel("Qual era o jogo mais vendido da história em 2018?");
		...
		rba1 = new JRadioButton("GTA V");
		rba2 = new JRadioButton("Tetris");
		rba3 = new JRadioButton("Minecraft");
		rba4 = new JRadioButton("GTA San Andreas");
		rba5 = new JRadioButton("Super Mario Bros");
...
//		lbp1.setFont(f);
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Jogo3());
