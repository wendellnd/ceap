...
public class Anime1 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	int tempo, a;
	File pink = new File("C:\\Users\\wende\\Downloads\\Quiz\\ha.wav");
	Clip clip;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\goku.jpg");
		...
		lbp1 = new JLabel("Qual o nome do golpe mais conhecido do Goku?");
		...
		rba1 = new JRadioButton("Kienzan");
		rba2 = new JRadioButton("Garlick Ho");
		rba3 = new JRadioButton("Final Flash");
		rba4 = new JRadioButton("Kamehameha");
		rba5 = new JRadioButton("Rasengan");
...
//		lbp1.setFont(f);
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Anime1());
