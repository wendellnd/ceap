...
public class Musica4 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	int tempo;
	File michael = new File("C:\\Users\\wende\\Downloads\\Quiz\\michael.wav");
	Clip clip;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\michael.jpg");
		...
		lbp1 = new JLabel("Em que ano Michael Jackson lançou Thriller?");
		...
		rba1 = new JRadioButton("1988");
		rba2 = new JRadioButton("1978");
		rba3 = new JRadioButton("1982");
		rba4 = new JRadioButton("1985");
		rba5 = new JRadioButton("1981");
...
//		lbp1.setFont(f);
	...
	public void DefinirEventos() {
		...
		btdica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Mesmo ano do surgimento de Legião Urbana");
			}
		});
	}
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Musica4());
