...
public class Musica5 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	File bee = new File("C:\\Users\\wende\\Downloads\\Quiz\\bee.wav");
	Clip clip;
	int tempo,a;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\bee.jpg");
		...
		lbp1 = new JLabel("Quem escreveu Für Elise?");
		...
		rba1 = new JRadioButton("Chopin");
		rba2 = new JRadioButton("Vivaldi");
		rba3 = new JRadioButton("Bach");
		rba4 = new JRadioButton("Mozart");
		rba5 = new JRadioButton("Beethoven");
...
//		lbp1.setFont(f);
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Musica5());
