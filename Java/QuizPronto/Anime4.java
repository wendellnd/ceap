...
public class Anime4 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\deku.png");
		...
		lbp1 = new JLabel("Qual a individualidade do Deku?");
		...
		rba1 = new JRadioButton("Meio Quente Meio Frio");
		rba2 = new JRadioButton("All for One");
		rba3 = new JRadioButton("One for All");
		rba4 = new JRadioButton("Ácido");
		rba5 = new JRadioButton("Super Força");
...
//		lbp1.setFont(f);
	...
	public void DefinirEventos() {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(null, "Um por Todos");
		}
		});
	}
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Anime4());
