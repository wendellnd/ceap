...
public class Jogo4 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	int tempo,a;
	File pink = new File("C:\\Users\\wende\\Downloads\\Quiz\\shao.wav");
	Clip clip;
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\mk.png");
		...
		lbp1 = new JLabel("Qual o primeiro Chefe final de Mortal Kombat?");
		...
		rba1 = new JRadioButton("Sub Zero");
		rba2 = new JRadioButton("Kotal Khan");
		rba3 = new JRadioButton("Shao Khan");
		rba4 = new JRadioButton("Kronika");
		rba5 = new JRadioButton("Raiden");
...
//		lbp1.setFont(f);
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Jogo4());
