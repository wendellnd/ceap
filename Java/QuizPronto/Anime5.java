...
public class Anime5 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\eren.jpg");
		...
		lbp1 = new JLabel("Quantos metros o titã do Eren mede?");
		...
		rba1 = new JRadioButton("10m");
		rba2 = new JRadioButton("14m");
		rba3 = new JRadioButton("3m");
		rba4 = new JRadioButton("60m");
		rba5 = new JRadioButton("15m");
...
//		lbp1.setFont(f);
	...
	public void DefinirEventos() {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(null,"Dia de Tiradentes-6");
		}
		});
	}
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Anime5());
