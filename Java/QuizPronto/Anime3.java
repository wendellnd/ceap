...
public class Anime3 extends JPanel{
//	Font f = new Font("SansSerif", Font.BOLD, 15);
	...
	public void InicializarComponentes() {
		setLayout(null);
		img = new ImageIcon("C:\\Users\\wende\\Downloads\\Quiz\\L.png");
		...
		lbp1 = new JLabel("Qual o nome do detetive L?");
		...
		rba1 = new JRadioButton("Lennister");
		rba2 = new JRadioButton("Lawliet");
		rba3 = new JRadioButton("Lucca");
		rba4 = new JRadioButton("Luigi");
		rba5 = new JRadioButton("Lorenzo");
...
//		lbp1.setFont(f);
	...
	public void DefinirEventos() {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(null,"Last One");
		}
		});
	}
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new Anime3());
