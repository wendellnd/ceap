...
def ResumoXO(es,a,b,p):
    ...
    p = 1
    return (a,b,p)
def Jogada(coor,ve,xo,p1,p2,loop,ganhap1,cont):
    loop2 = 0
    while loop2 == 0:
        ...
        if (coor >= 1 and coor <= 9) and ve[coor-1] == " ":
            ...
            p1 = 1
            p2 = 0
            loop,cont = Ganha(loop,xo,ve,ganhap1,cont)
            loop2 = 1
    return (ve,p1,p2,loop,cont)
def Ganha(loop,a,ve,ganha,cont):
...
while loopdeus == 0:
    ...
    while loop == 0:
        print("\n"*100+ve[0]+"|"+ve[1]+"|"+ve[2]+"\n"+ve[3]+"|"+ve[4]+"|"+ve[5]+"\n"+ve[6]+"|"+ve[7]+"|"+ve[8]+"\n")
        if p1 == 0:
            ve,p1,p2,loop,contp1 = Jogada(coor,ve,xo,p1,p2,loop,ganhap1,contp1)
        elif p2 == 0:
            ve,p2,p1,loop,contp2 = Jogada(coor,ve,ox,p2,p1,loop,ganhap2,contp2) 
